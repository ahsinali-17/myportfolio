...
const Project = () => {
  ...
  return (
    ...
    <section className="second w-full mt-[10vh] mb-6">
      <h1 className="text-4xl font-semibold w-5/6 mx-auto mb-4">Projects</h1>
      <div className="projects flex flex-wrap items-center justify-center gap-8 w-full">
        <div className="pro flex flex-col items-center justify-center bg-gray-500 p-6 mt-3 lg:w-1/4 h-[55vh] rounded-lg gap-8 w-5/6 cursor-pointer">
        <a    className="connectify shadoww"
          ...
          <div>
            ...
            <p>
              A feature-rich MERN-stack social media application with complete user authentication/ authorization. 
            </p>
          </div>
        </div>
        ...
        <div className="pro flex flex-col items-center justify-center bg-gray-500 p-6 mt-3 lg:w-1/4 h-[55vh] rounded-lg gap-8 w-5/6 cursor-pointer">
          ...
          <div>
            ...
            <p>
            A MERN-stack app to store passwords and related info using mongoDb. Features like Edit, delete and copy are enabled.
            </p>
          </div>
        </div>
      ...
      <div className="h-projects flex-wrap items-center justify-center gap-8 w-full" style={{display: "none"}}>
        <div className="h-pro flex flex-col items-center justify-center bg-gray-500 p-6 mt-3 lg:w-1/4 h-[55vh] rounded-lg gap-8 w-5/6 cursor-pointer">
          <a    className="spotify shadoww"
          ...
          <div>
            ...
            <p>
            2 player React game with player vs computer mode using React router and undo feature is enabled using localStorage.
            </p>
          </div>
        </div>
        ...
        <div className="h-pro flex flex-col items-center justify-center bg-gray-500 p-6 mt-3 lg:w-1/4 h-[55vh] rounded-lg gap-8 w-5/6 cursor-pointer">
          ...
          <div>
            ...
            <p>
            A React game in whuch player has to guess the dice number right to get points otherwise 2 points will be deducted.
            </p>
          </div>
        </div>
        <div className="h-pro flex flex-col items-center justify-center bg-gray-500 p-6 mt-3 lg:w-1/4 h-[55vh] rounded-lg gap-8 w-5/6 cursor-pointer">
          
            <a className="amazon shadoww"
          ...
          <div>
            ...
            <p>
            Amazon UI clone using HTML and CSS. It is a responsive clone of Amazon website.
            </p>
          </div>
        </div>
      </div>
