export const Bio = {
  ...
  resume: "https://drive.google.com/file/d/1-SQUCicx5j3j-NuwrrXl_1Jj-a4Re54b/view?usp=sharing",
...
export const projects = [
  {
    ...
    tags: ["React Js", "Computer Vision", "RT-DETR", "Tailwind CSS", "Express Js","Flask", "Supabase", "jsPDF", "Tanstack"],
    category: "AI web app",
    ...
    features: ["Real-time AI Defect Detection", 
      ...
      "LiveImage Scanning"],
    challenges: "Fine-tuning a custom Detection Transformer (DFTR), ensuring frontend state integrity via TanStack Query; optimizing PDF report generation speed using parallel fetching, resolving dependency conflicts in headless Docker deployments.",
    duration: "6 months",
  },
  {
    id: 1,
